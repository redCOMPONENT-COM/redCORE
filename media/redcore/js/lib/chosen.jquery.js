    ...
    * ================================================= */
    ...
    AbstractChosen.prototype.set_default_text = function() {
      ...
      if (this.form_field.getAttribute("data-placeholder")) {
        ...
        this.default_text = this.options.placeholder_text_multiple || this.options.placeholder_text || Joomla.JText.JGLOBAL_SELECT_SOME_OPTIONS || Joomla.JText._('JGLOBAL_SELECT_SOME_OPTIONS');
	  } else if (this.allow_custom_value) {
        this.default_text = this.options.placeholder_text_single || this.options.placeholder_text || Joomla.JText.JGLOBAL_TYPE_OR_SELECT_SOME_OPTIONS || Joomla.JText._('JGLOBAL_TYPE_OR_SELECT_SOME_OPTIONS');
      } else {
        this.default_text = this.options.placeholder_text_single || this.options.placeholder_text || Joomla.JText.JGLOBAL_SELECT_AN_OPTION || Joomla.JText._('JGLOBAL_SELECT_AN_OPTION');
      }
      ...
      return this.results_none_found = this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || Joomla.JText.JGLOBAL_SELECT_NO_RESULTS_MATCH || Joomla.JText._('JGLOBAL_SELECT_NO_RESULTS_MATCH');
    };
