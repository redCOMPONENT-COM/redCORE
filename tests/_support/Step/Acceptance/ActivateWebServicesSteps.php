...
class ActivateWebServicesSteps extends \AcceptanceTester
{
	...
	public function doWebserviceManager(){
		...
		$I->waitForText(ActWebPage::$pathContactWebservice1, 30, ActWebPage::$path);
		$I->waitForText(ActWebPage::$pathContactWebservice2, 30, ActWebPage::$path);
		$I->waitForText(ActWebPage::$pathUserWebservice, 30, ActWebPage::$path);
	}
}