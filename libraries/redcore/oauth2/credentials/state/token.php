...
/**
 * OAuth Token Credentials class for the redCORE
 *
 * @package     Redcore
 * @subpackage  OAuth2
 * @since       1.0
 */
class ROauth2CredentialsStateToken extends ROauth2CredentialsState
{
	/**
	...
	public function revoke()
	{
		...
		return new ROauth2CredentialsStateRevoked($this->table);
	}
}
