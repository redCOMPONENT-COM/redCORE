		...
		<div class="form-horizontal">
			<div class="input-group input-group-sm">
				...
				<fieldset class="radio btn-group">
					<input id="<?php echo $id;?>_admin1" type="radio" name="jform[formLinks][<?php echo $id;?>][admin]"
					...
					<input id="<?php echo $id;?>_admin0" type="radio" name="jform[formLinks][<?php echo $id;?>][admin]"
			...
			<div class="input-group input-group-sm">
				...
				<input type="text" name="jform[formLinks][<?php echo $id;?>][option]" value="<?php echo $editForm->option;?>" class="form-control" />
			</div>
			<div class="input-group input-group-sm">
				...
				<input type="text" name="jform[formLinks][<?php echo $id;?>][view]" value="<?php echo $editForm->view;?>" class="form-control" />
			</div>
			<div class="input-group input-group-sm">
				...
				<input type="text" name="jform[formLinks][<?php echo $id;?>][layout]" value="<?php echo $editForm->layout;?>" class="form-control" />
			</div>
			<div class="input-group input-group-sm">
				...
				<input type="text" name="jform[formLinks][<?php echo $id;?>][identifier]" value="<?php echo $editForm->identifier;?>" class="form-control" />
			</div>
			<div class="input-group input-group-sm">
				...
				<fieldset class="radio btn-group">
					<input id="<?php echo $id;?>_showbutton1" type="radio" name="jform[formLinks][<?php echo $id;?>][showbutton]"
					...
					<input id="<?php echo $id;?>_showbutton0" type="radio" name="jform[formLinks][<?php echo $id;?>][showbutton]"
			...
			<div class="input-group input-group-sm">
				...
				<input type="text" name="jform[formLinks][<?php echo $id;?>][htmlposition]" value="<?php echo $editForm->htmlposition;?>" class="form-control" />
			</div>
			<div class="input-group input-group-sm">
				...
				<fieldset class="radio btn-group">
					<input id="<?php echo $id;?>_checkoriginalid1" type="radio" name="jform[formLinks][<?php echo $id;?>][checkoriginalid]"
					...
					<input id="<?php echo $id;?>_checkoriginalid0" type="radio" name="jform[formLinks][<?php echo $id;?>][checkoriginalid]"
